...
<input type="hidden" name="idStagiaire" readonly required value="<?=$uneEval->getIdStagiaire()?>">
    <div class="col-12 col-md-8 col-lg-6 mx-auto">
        ...
        <div class="row my-2">
            ...
            <input class="form-control" name="date" id="inputdate" type="date" required min="2021-01-01" value="<?=$uneEval->getDateEvaluation()?>" >
        </div>
        <div class="row my-2">
            <label for="inputNote">Note</label>
            <input class="form-control" name="note" id="inputNote" type="number" required step="0.01" min="0" max="20" value="<?=$uneEval->getNote()?>">
        </div>
        <div class="row my-2">
